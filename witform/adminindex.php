<?php
    ...
    if (isset($_SESSION['admin'])) {
        ...
        $query1 = "SELECT * FROM admin WHERE username='$adminusername';";
        $result1 = mysqli_query($conn, $query1);
        $resultrows1 = mysqli_fetch_assoc($result1) 
?>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <body>
            ...
            <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                    ...
                    <h1 class="my-4 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%); font-size:50px">Staff Details</h1>
                        <div class="my-5 display-5 fw-normal px-md-5" style="color: hsl(218, 81%, 95%); font-size:30px">
                            First Name: <?php echo $resultrows1['firstname']; ?> <br>
                            Last Name: <?php echo $resultrows1['lastname']; ?> <br>
                            Gender: <?php echo $resultrows1['gender']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Working in institution since: <?php echo $resultrows1['since']; ?> <br>
                            Subject: <?php echo $resultrows1['subject']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Experience: <?php echo $resultrows1['exp']; ?> Years <br>
                            Phone number: <?php echo $resultrows1['phoneno']; ?> <br>
                            Address of Residence: <?php echo $resultrows1['address']; ?> <br>
                        </div>
                    </div>
                    </div>
                </div>
