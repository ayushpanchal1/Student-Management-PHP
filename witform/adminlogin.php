...
<body>
    ...
    <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
            ...
            Only for<br />
            <span style="color: hsl(218, 81%, 75%)">registered administrators</span>
            </h1>
            <a href="login.php"><p class="mb-4 opacity-70" style="color: hsl(218, 81%, 85%)">
            Want to log in as a normal user? Click here.
            </p></a>
        </div>
        ...
        <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
            ...
            <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%); font-size:50px">Admin Log in</h1>
